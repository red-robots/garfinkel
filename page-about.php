...
<div id="primary" class="content-area aboutpage default cf <?php echo $has_header_image ?>">
  <?php while ( have_posts() ) : the_post(); ?>
    ...
    <?php 
    $row3_repeater_blocks = get_field("row3_repeater_blocks"); 
    ...
    if($row3_repeater_blocks) { ?>
    <section class="contentrow arow3 row3_repeater_blocks">
    <?php foreach ($row3_repeater_blocks as $b) { 
      $title_small = $b['title_small'];
      $title_large = $b['title_large'];
      $text = $b['text'];
      $image = $b['image'];
      if($title_large || $text || $image) { ?>
        <div class="wrapper-narrow">
          <div class="flexwrap">
            <?php if ($image) { ?>
            ...
            <?php if ($title_large || $text) { ?>
            <div class="r3col textcol">
              <?php if ($title_small) { ?>
              <h3 class="title-small"><?php echo $title_small ?></h3> 
              <?php } ?>
              <?php if ($title_large) { ?>
              <h3 class="title-big"><?php echo $title_large ?></h3> 
              <?php } ?>
              <?php echo $text ?>
            </div>
            <?php } ?>
